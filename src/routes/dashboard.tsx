...
export const Route = createFileRoute("/dashboard")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Your momentum score, consistency, and today's missions at a glance.",
      },
    ],
  }),
  component: Dashboard,
...
function StatChip({
  ...
  return (
    <div className="glass-panel rounded-2xl p-4 flex items-center gap-3">
      <div
        className={`size-9 rounded-xl bg-white/5 border border-glass-border grid place-items-center ${colorMap[tone]}`}
      >
    ...
    <div className="space-y-8">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3 text-[10px] font-mono">
              <span className="flex items-center gap-1.5">
                <span className="size-2 rounded-full bg-momentum" />
                Focus
              </span>
              <span className="flex items-center gap-1.5">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-hud text-[10px] text-momentum hover:underline">
            NEW PROJECT
          </button>
        </div>
